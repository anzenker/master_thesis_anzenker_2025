...
def process_fasta(input_file, output_ids_path, output_tsv_path, log_path):
...
if __name__ == "__main__":
    ...
    process_fasta(args.input_file, output_read_ids_txt, output_pattern_info_tsv, log_file)