...
process plotOverviewQuality {
    ...
    python $python_script $input_gtf $input_fasta "${input_pep}/${input_fasta.baseName}.transdecoder_dir/longest_orfs.pep" $input_busco $input_eggnog overview_quality --species_name $species_name
    """ 
}
